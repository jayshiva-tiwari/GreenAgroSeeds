          ...
          {showCloseButton && (
            <DialogPrimitive.Close
              ...
              render={
                <Button
                  variant="ghost"
                  className="absolute top-4 right-4 z-50 h-8 w-8 rounded-full bg-slate-100/50 hover:bg-slate-200/50 backdrop-blur-sm"
                  size="icon"
                />
              }
            >
